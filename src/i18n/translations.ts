...
const dict = {
  ...
  seats_your_pick:        { mm: 'သင်ရွေးချယ်ပြီး',               en: 'Your pick' },
  ...
  seats_window_note:      { mm: 'A နှင့် B သည် ဝင်းဆွဲဘေး · C နှင့် D သည် လမ်းဆုံဘေး', en: 'Seats A & B are by the window · C & D are aisle-side' },
  ...
  seats_window:           { mm: 'ဝင်းဆွဲ',                       en: 'Window' },
  seats_aisle:            { mm: 'လမ်းဆုံ',                       en: 'Aisle' },
  ...
  verify_nrc_format:      { mm: 'ပုံစံ: မြို့နယ်ကုဒ် / နာမည် (မိဘ) + ဂဏန်း ၆ လုံး', en: 'Format: township code / name (parent) + 6 digits' },
